...
const pages = ['Your Course', 'Profs', 'Library'];
const settings = [<Link to="/profil">Profile</Link>, 'Account', <Link to="/dashboardProf">Dashboard</Link>, 'Logout'];
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
            ...
            >
              {pages.map((page) => page=="Your Course"?
                <MenuItem key={page} onClick={handelCourses}>
